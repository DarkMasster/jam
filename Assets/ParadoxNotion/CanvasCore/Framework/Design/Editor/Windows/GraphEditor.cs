...
namespace NodeCanvas.Editor
{
    ...
    public partial class GraphEditor : EditorWindow
    {
        ...
        private EntityId _rootGraphEntityID;
#else
...
#if UNITY_6000_5_OR_NEWER
        private EntityId _targetOwnerEntityID;
#else
...
#if UNITY_6000_5_OR_NEWER
                    current._rootGraph = EditorUtility.EntityIdToObject(current._rootGraphEntityID) as Graph;
#else
...
#if UNITY_6000_5_OR_NEWER
                current._rootGraphEntityID = value != null ? value.GetEntityId() : EntityId.None;
#else
...
#if UNITY_6000_5_OR_NEWER
                    current._targetOwner = EditorUtility.EntityIdToObject(current._targetOwnerEntityID) as GraphOwner;
#else
...
#if UNITY_6000_5_OR_NEWER
                current._targetOwnerEntityID = value != null ? value.GetEntityId() : EntityId.None;
#else
...
#pragma warning disable CS0618
            var target = EditorUtility.EntityIdToObject(instanceID) as Graph;
