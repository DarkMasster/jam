...
namespace Jam.Core.Localization.Editor
{
    public static class LocalizationSetup
    {
        ...
        private static readonly Entry[] PhotoEntries =
        {
            ...
            new("production.publish.wings", "МАСКА «КРЫЛЬЯ»  •  +50 Признание", "WINGS MASK  •  +50 Recognition"),
            new("production.publish.honest", "ЧЕСТНОЕ ФОТО ПОВЕСТКИ  •  +50 Честность", "HONEST DRAFT-NOTICE PHOTO  •  +50 Honesty"),
            new("production.publish.balance", "КАДРИРОВАНИЕ / БАЛАНС  •  +25 / +25", "FRAMING / BALANCE  •  +25 / +25"),
