...
namespace Jam.Episodes.Office
{
    ...
    public sealed class OfficeReflectionBeat : MonoBehaviour, IOfficeRunResettable
    {
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            SetEchoVisible(true);
            var localizedMessage = Loc.Get(LocalizationTables.Office, "coach.reflection", beatMessage);
            episodeController?.ReportStoryBeat(localizedMessage);
            coach?.ShowBeat(localizedMessage, beatMessageDuration);
        }
